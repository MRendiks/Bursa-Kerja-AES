...
if (isset($_POST["submit"]) ) {
    ...
    echo "
            <script>
                alert('gagal');
                document.location.href = 'invfinal_round.php';
            </script>
        ";
}   }
    ...
    <div class="col-lg-8 col-lg-offset-2 well">
      <div class="panel panel-info">
        <div class="panel-heading " style="background-color: #fff;">
          ...
          <h3 class="text-center">TAHAPAN PROSES DEKRIPSI ALGORITMA RIJNDAEL</h3>
                        ...
                        <fieldset>
                            ...
                            <div class="panel-body">
                                <form action="" class="form-horizontal row">
                                    <div class="form-group">
                                        <label for="subbytes" class="control-label col-sm-3"> InvShiftRow </label>
                                        <div class="col-sm-6">
                            ...
                            <div class="panel-body">
                                <form action="" class="form-horizontal row">
                                    <div class="form-group">
                                        <label for="shiftrow" class="control-label col-sm-3"> InvSubBytes </label>
                                        <div class="col-sm-6">
                            ...
                            <div class="panel-body">
                                <form action="" class="form-horizontal row">
                                    <div class="form-group">
                                        <label for="addroundkey" class="control-label col-sm-3"> Add RoundKey / Plaintext </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="addroundkey" id="addroundkey" class="form-control" value="<?= $state_6 ?>" readonly>
                                        </div>
                                        <div style="color: #a7b305;">
                                        <?php 
                                    
                                        $plaintext_matrix = $hit->blockToMatrix($state_6);
                            ...
                            <form action="" class="form-horizontal row">
                                <div>
                                    <label for="state" style="">Hasil dari Add RoundKey round 10 yang bisa juga disebut Cipher Text karena hasil
