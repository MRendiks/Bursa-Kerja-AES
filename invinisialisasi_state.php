...
if (isset($_POST["submit"]) ) {
    ...
    if ( ($_POST) > 0 ) {
        ...
        echo "
            <script>
                document.location.href = 'invsembilan_round.php';
            </script>
        ";
    ...
    echo "
            <script>
                alert('gagal');
                document.location.href = 'invinisialisasi_state.php';
            </script>
        ";
}   }
    ...
    <div class="col-lg-8 col-lg-offset-2 well">
      <div class="panel panel-info">
        <div class="panel-heading " style="background-color: #fff;">
          ...
          <h3 class="text-center">TAHAPAN PROSES DEKRIPSI ALGORITMA RIJNDAEL</h4>

                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal row">
                        <fieldset>
                            <legend class="text-center" style="color: #d6295d; "> Inverse State dan Inisialisasi </legend>
                            <div class="panel-body">
                                    <form action="" class="form-horizontal row">
                                <div class="form-group">
                                    <label for="state" class="control-label col-sm-3">Ciphertext / State </label>
                            ...
                            <div class="panel-body">
                                    <form action="" class="form-horizontal row">
                                <div class="form-group">
                                    <label for="inisialisasi" class="control-label col-sm-3">Inisialisasi / RoundKey 10</label>
                                    <div class="col-sm-5">
                            ...
                            <div class="panel-body">
                                    <form action="" class="form-horizontal row">
                                <div class="form-group">
                                    <label for="roundkey" class="control-label col-sm-3"> Add RoundKey </label>
                                    <div class="col-sm-5">
