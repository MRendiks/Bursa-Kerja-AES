        ...
        <div class="wrapperr wrapperr--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Edit Daftar Lowongan</h2>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-roww">
                            ...
                            <div class="value">
                                <input class="input--style-66" type="text" name="perusahaan" value="<?= $lowongan["perusahaan"]; ?>">
                            </div>
                        </div>
                        <div class="form-roww">
                            <div class="name">Lowongan Tersedia</div>
                            <div class="value">
                                <input class="input--style-66" type="text" name="lowongan" value="<?= $lowongan["lowongan"]; ?>">
                            </div>
                        </div>
                        <div class="form-roww">
                            <div class="name">Lokasi Perusahaan</div>
                            <div class="value">
                                <input class="input--style-66" type="text" name="lokasi" value="<?= $lowongan["lokasi"]; ?>">
                            </div>
                        </div>
                        <div class="form-roww">
                            <div class="name">Website</div>
                            <div class="value">
                                <input class="input--style-66" type="text" name="web" value="<?= $lowongan["web"]; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-roww">
                            ...
                            <div class="value">
                                <div class="input-groupp">
                                    <textarea class="textarea--style-66" name="deskripsi"><?= $lowongan["deskripsi"]; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-roww">
                        ...
                        <div class="card-footer">
                            ...
                            <button class="btnn btnn--radius-2 btnn--blue-2" type="submit" name="submit">Update</button>
                        </div>
                    </form>
                </div>
